    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: NAVY }}>
      <ScrollView contentContainerStyle={{ padding: 20 }}>
        ...
        <View style={s.verifiedCard}>
          ...
          <Text style={s.name}>Jennifer Mitchell</Text>
          <Text style={s.sub}>Homeowner · San Antonio, TX</Text>
          <View style={s.badges}>
            <View style={s.badgeGreen}><Text style={s.badgeGreenText}>✅ Active</Text></View>
            <View style={s.badgeAmber}><Text style={s.badgeAmberText}>🚫 Decal Registered</Text></View>
          </View>
        </View>
        ...
        <View style={s.card}>
          {[
            { label: 'Name',    value: 'Jennifer Mitchell' },
            { label: 'Email',   value: 'jennifer@email.com' },
            { label: 'Phone',   value: '(210) 555-0192' },
            { label: 'Address', value: '432 Oak Creek Dr' },
            { label: 'ZIP',     value: '78154' },
          ].map((row, i, arr) => (
...
const s = StyleSheet.create({
  ...
  rowValue:       { fontSize: 13, color: WHITE },
